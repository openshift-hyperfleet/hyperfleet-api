...
hyperfleet requires the following tools to be pre-installed:
...
- **Purpose**: In our project, Go is required for building and running the `hyperfleet` binary required by hyperfleet.
...
Make sure all these prerequisites are installed before running hyperfleet.