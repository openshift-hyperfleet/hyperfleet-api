...
export default function () {
  ...
  const options = {
    ...
    group("/api/hyperfleet/v1/dinosaurs", () => {
        ...
        // Request No. 1: 
        {
            let url = BASE_URL + `/api/hyperfleet/v1/dinosaurs?page=${page}&size=${size}&search=${search}&orderBy=${orderBy}&fields=${fields}`;
        ...
        {
            let url = BASE_URL + `/api/hyperfleet/v1/dinosaurs`;
      ...
      group("/api/hyperfleet/v1/dinosaurs/{id}", () => {

        // Request No. 1: 
        {
            let url = BASE_URL + `/api/hyperfleet/v1/dinosaurs/${id}`;
            let request = http.get(url,options);
