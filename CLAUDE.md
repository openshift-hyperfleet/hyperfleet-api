...
- OpenAPI spec and code generation: see [openapi/CLAUDE.md](openapi/CLAUDE.md) — run `make generate` before building; generated files in `pkg/api/openapi/` are **never edited**
...
- **OpenAPI spec**: not tracked in git — see [openapi/CLAUDE.md](openapi/CLAUDE.md) for spec versioning and generation details
