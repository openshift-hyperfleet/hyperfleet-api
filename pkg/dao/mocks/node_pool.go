...
func (d *nodePoolDaoMock) RequestDeletion(ctx context.Context, id string, actor string) (*api.NodePool, error) {
	return nil, errors.NotImplemented("NodePool").AsError()
}
...
func (d *nodePoolDaoMock) RequestDeletionByOwner(ctx context.Context, ownerID string, t time.Time, actor string) error {
	return errors.NotImplemented("NodePool").AsError()
}
