...
func (r ApiGetClusterByIdRequest) Search(search string) ApiGetClusterByIdRequest {
	r.search = &search
	return r
}

func (r ApiGetClusterByIdRequest) Execute() (*Cluster, *http.Response, error) {
...
//
//	@return Cluster
func (a *DefaultAPIService) GetClusterByIdExecute(r ApiGetClusterByIdRequest) (*Cluster, *http.Response, error) {
	var (
...
func (r ApiGetClusterStatusesRequest) Execute() (*AdapterStatusList, *http.Response, error) {
...
func (a *DefaultAPIService) GetClusterStatusesExecute(r ApiGetClusterStatusesRequest) (*AdapterStatusList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AdapterStatusList
	)
...
*/
func (a *DefaultAPIService) GetNodePoolById(ctx context.Context, clusterId string, nodepoolId string) ApiGetNodePoolByIdRequest {
	return ApiGetNodePoolByIdRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
func (a *DefaultAPIService) GetNodePoolByIdExecute(r ApiGetNodePoolByIdRequest) (*NodePool, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/hyperfleet/v1/clusters/{cluster_id}/nodepools/{nodepool_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
...
func (r ApiGetNodePoolsRequest) Execute() (*NodePoolList, *http.Response, error) {
...
//
//	@return NodePoolList
func (a *DefaultAPIService) GetNodePoolsExecute(r ApiGetNodePoolsRequest) (*NodePoolList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *NodePoolList
	)
...
func (r ApiGetNodePoolsByClusterIdRequest) Execute() (*NodePoolList, *http.Response, error) {
...
//
//	@return NodePoolList
func (a *DefaultAPIService) GetNodePoolsByClusterIdExecute(r ApiGetNodePoolsByClusterIdRequest) (*NodePoolList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetNodePoolsStatusesRequest) Execute() (*AdapterStatusList, *http.Response, error) {
...
//
//	@return AdapterStatusList
func (a *DefaultAPIService) GetNodePoolsStatusesExecute(r ApiGetNodePoolsStatusesRequest) (*AdapterStatusList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPostClusterRequest) Execute() (*Cluster, *http.Response, error) {
...
//
//	@return Cluster
func (a *DefaultAPIService) PostClusterExecute(r ApiPostClusterRequest) (*Cluster, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
