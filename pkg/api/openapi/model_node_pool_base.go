...
// checks if the NodePoolBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodePoolBase{}

// NodePoolBase struct for NodePoolBase
type NodePoolBase struct {
...
type _NodePoolBase NodePoolBase
...
func (o NodePoolBase) MarshalJSON() ([]byte, error) {
...
func (o NodePoolBase) ToMap() (map[string]interface{}, error) {
...
func (o *NodePoolBase) UnmarshalJSON(data []byte) (err error) {
	...
	varNodePoolBase := _NodePoolBase{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodePoolBase)

	if err != nil {
		return err
	}

	*o = NodePoolBase(varNodePoolBase)

	return err
}

type NullableNodePoolBase struct {
	value *NodePoolBase
	isSet bool
}

func (v NullableNodePoolBase) Get() *NodePoolBase {
	return v.value
}

func (v *NullableNodePoolBase) Set(val *NodePoolBase) {
	v.value = val
	v.isSet = true
}

func (v NullableNodePoolBase) IsSet() bool {
	return v.isSet
}

func (v *NullableNodePoolBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodePoolBase(val *NodePoolBase) *NullableNodePoolBase {
	return &NullableNodePoolBase{value: val, isSet: true}
}

func (v NullableNodePoolBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodePoolBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
