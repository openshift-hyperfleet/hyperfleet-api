...
func TestResourceCondition_JSONSerialization(t *testing.T) {
	...
	fullCondition := ResourceCondition{
		...
		CreatedTime:        now,
		LastUpdatedTime:    now,
		Type:               AdapterConditionTypeReady,
	...
	Expect(jsonMap["type"]).To(Equal(AdapterConditionTypeReady))
	...
	minimalCondition := ResourceCondition{
		...
		CreatedTime:        now,
		LastUpdatedTime:    now,
		Type:               AdapterConditionTypeAvailable,
...
func TestAdapterCondition_JSONDeserialization(t *testing.T) {
	...
	Expect(unknownCondition.Type).To(Equal(AdapterConditionTypeAvailable))
