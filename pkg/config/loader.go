...
func (l *ConfigLoader) handleFileSecrets(ctx context.Context) error {
	...
	fileSecretMappings := map[string]string{
		...
		"HYPERFLEET_DATABASE_SSL_ROOT_CERT_FILE":  "database.ssl.root_cert_file",
		...
		"HYPERFLEET_SERVER_TLS_CERT_FILE_FILE":    "server.tls.cert_file",
		"HYPERFLEET_SERVER_TLS_KEY_FILE_FILE":     "server.tls.key_file",
		"HYPERFLEET_SERVER_JWK_CERT_FILE_FILE":    "server.jwk.cert_file",
		"HYPERFLEET_SERVER_ACL_FILE_FILE":         "server.acl.file",
	}
