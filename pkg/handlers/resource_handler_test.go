...
func TestResourceHandler_Create_NameValidation(t *testing.T) {
	tests := []struct {
		...
		{"valid name with zero lengths", "valid-name", 0, 0, http.StatusCreated},
		{"exceeds dbNameMaxLen fallback", "a" + strings.Repeat("b", 100), 0, 0, http.StatusBadRequest},
	}
