...
func TestParsePrevConditions(t *testing.T) {
	...
	t.Run("only LastKnownReconciled", func(t *testing.T) {
		t.Parallel()
...
func TestComputeReconciled(t *testing.T) {
	...
	t.Run(name, func(t *testing.T) {
		...
		if cond.Reason == nil || *cond.Reason != reasonReconciledWaitingForChildren {
			t.Errorf("Reason got %v, want %q", cond.Reason, reasonReconciledWaitingForChildren)
		}
	})
	...
	t.Run("deletedTime set, all Finalized=True, hasChildResources=false → True", func(t *testing.T) {
		...
		if cond.Reason == nil || *cond.Reason != reasonReconciledAll {
			t.Errorf("Reason got %v, want %q", cond.Reason, reasonReconciledAll)
		}
	})
}
...
func TestAggregateResourceStatus(t *testing.T) {
	...
	t.Run("split generations with prev LastKnownReconciled=True → stays True (sticky)", func(t *testing.T) {
		t.Parallel()
		required := []string{"a", "b"}
